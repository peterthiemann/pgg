...
(define gen-binding (lambda (x y) (cons x y)))
; generates a type binding, binding a symbol to a type variable

(define binding-key (lambda (x) (car x)))
; returns the key of a type binding

(define binding-value (lambda (x) (cdr x)))
